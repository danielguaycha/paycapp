...
class DownLoadExamplePage extends StatefulWidget with WidgetsBindingObserver {

  DownLoadExamplePage({Key key, this.title}) : super(key: key);

  final String title;

  @override
  _DownLoadExamplePageState createState() => new _DownLoadExamplePageState();
}
